...
-(void)initNavigationWithTitle:(NSString*)title{
    self.navigationController.navigationBar.backgroundColor = ThemeColor(@"Navigation_Bg_Color");
    self.navigationController.navigationBar.tintColor = [UIColor whiteColor];
    CGFloat w = self.view.frame.size.width;
    CGFloat h = 44;
    h += 22;
    self.navigationController.navigationBar.barTintColor = [UIColor whiteColor];
    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageWithColor:ThemeColor(@"Navigation_Bg_Color") andSize:CGSizeMake(w, h)] forBarMetrics:UIBarMetricsDefault];
