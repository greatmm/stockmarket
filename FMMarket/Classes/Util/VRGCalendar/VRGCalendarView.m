...
-(void)selectDate:(int)date {
    ...
    [comps setDay:date];
    selectedDate = [gregorian dateFromComponents:comps];
...
- (void)handleSwipes:(UISwipeGestureRecognizer *)sender
{
    ...
    if (sender.direction == UISwipeGestureRecognizerDirectionRight || sender.direction==UISwipeGestureRecognizerDirectionDown) {
        [self showPreviousMonth];
    }
}
