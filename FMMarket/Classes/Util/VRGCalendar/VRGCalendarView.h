...
#define kVRGCalendarViewWidth (UIScreenWidth-40)

#define kVRGCalendarViewDayWidth (kVRGCalendarViewWidth-15)/7
#define kVRGCalendarViewDayHeight kVRGCalendarViewDayWidth
