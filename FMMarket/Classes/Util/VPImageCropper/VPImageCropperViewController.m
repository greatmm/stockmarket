...
- (void)initView {
    ...
    self.showImgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, UIScreenWidth, UIScreenHeight)];
    ...
    self.ratioView.hidden = self.hideRatio;
...
- (void)initControlBtn {
    UIView *bg = [[UIView alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - 50.0f, self.view.frame.size.width, 50)];
