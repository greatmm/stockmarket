...
@interface FMSelfStocksModel : NSObject
...
@property (nonatomic,retain) NSString *signal;          // 信号 －1未知 0=B 1=S
@property (nonatomic,assign) NSString *orderValue;      // 排序 由低到高
@property (nonatomic,retain) NSString *timestamp;       // 时间戳
@property (nonatomic,retain) NSString *isRemind;        // 是否提醒
@property (nonatomic,retain) NSString *userId;          // 绑定用户
