...
@interface FMKLineWeekView()<UIScrollViewDelegate>{

}

@end

@implementation FMKLineWeekView

-(void)dealloc{
    NSLog(@"FMKLineWeekView dealloc");
}
...
-(void)startGetHttpStockDays{
    __FMWeakSelf;
    [HttpManager getHttpStockWeeksWithCode:self.model.stockCode fuquanType:[self fuquanType:self.model.fuquanType]  StartBlock:^{
